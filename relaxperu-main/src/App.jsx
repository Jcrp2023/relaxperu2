...
const copy = {
  es: {
    ...
    today: 'Hoy', week: 'Próximos 7 días', anytime: 'Todos los planes', exploreAnytime: 'Para explorar', all: 'Todos', shows: 'Música, conciertos y salsódromos', travel: 'Turismo regional, naturaleza y agendas municipales',
  ...
  en: {
    ...
    today: 'Today', week: 'Next 7 days', anytime: 'All plans', exploreAnytime: 'Explore anytime', all: 'All', shows: 'Music, concerts & salsa clubs', travel: 'Regional travel, nature & municipal events',
