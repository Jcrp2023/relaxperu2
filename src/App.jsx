...
const copy = {
  es: {
    ...
    today: 'Hoy', week: 'Próximos 7 días', anytime: 'Todos los planes', exploreAnytime: 'Para explorar', all: 'Todos', unclassified: 'Por clasificar', classificationNote: 'Las fichas pendientes de clasificación aparecen en “Todos” y en la búsqueda; los filtros de macro-nódulo solo incluyen fichas clasificadas.', shows: 'Música, conciertos y salsódromos', travel: 'Turismo regional, naturaleza y agendas municipales',
    food: 'Gastronomía, huariques, catas y viñedos', culture: 'Arte, teatro, cines y cultura', family: 'Mascotas y Pet Friendly', wellness: 'Estilo de vida, solteros, K-Pop y geek', sports: 'Deporte, fitness y running clubs', featured: 'Ideas para salir', results: 'planes encontrados', source: 'Fuente',
  ...
  en: {
    ...
    today: 'Today', week: 'Next 7 days', anytime: 'All plans', exploreAnytime: 'Explore anytime', all: 'All', unclassified: 'Unclassified', classificationNote: 'Unclassified listings remain under “All” and in search; macro-node filters include classified listings only.', shows: 'Music, concerts & salsa clubs', travel: 'Regional travel, nature & municipal events',
    food: 'Food, huariques, tastings & vineyards', culture: 'Arts, theater, cinema & culture', family: 'Pets & pet-friendly', wellness: 'Lifestyle, singles, K-pop & geek', sports: 'Sports, fitness & running clubs', featured: 'Ideas to go out', results: 'plans found', source: 'Source',
